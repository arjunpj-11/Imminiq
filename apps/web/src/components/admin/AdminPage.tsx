  ...
  return (
    <header className="admin-page-header flex flex-wrap items-end justify-between gap-5">
      <div className="min-w-0">
        ...
        <h1 className="admin-page-title font-editorial mt-1 text-4xl font-bold">
          {title}
        </h1>
        <p className="admin-page-description mt-2 max-w-2xl text-sm">
          {description}
        </p>
      </div>
      {action && (
...
export function AdminMetricGrid({ metrics }: { metrics: AdminMetric[] }) {
  return (
    <section
      ...
      className="mt-7 grid grid-cols-[repeat(auto-fit,minmax(min(100%,14rem),1fr))] gap-4"
    >
...
export function AdminEmpty({
  ...
  return (
    <div
      className="grid min-h-52 place-items-center p-8 text-center"
      role="status"
    >
      <div>
...
export function AdminRefreshingIndicator({
