...
export function ContentModerationAppealPanel({ targetType, targetId }: { targetType: 'tracker' | 'mock_test'; targetId: string }) {
  ...
  const eligibilityCopy = targetType === 'tracker'
