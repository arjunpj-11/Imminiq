...
const getPasswordStrength = (password: string) => {
  ...
  if (score === 2) return { score, label: 'Middling' }
...
const inputBaseClass = (error?: string, valid?: boolean) =>
  cn(
    ...
    valid && !error && 'border-[#4caf7d] shadow-[0_0_0_3px_rgba(76,175,125,0.08)] dark:border-[#5cc98a]'
  )

const strengthColors: Record<number, string> = {
  1: 'bg-[#d94535] dark:bg-[#ff6b5f]',
  2: 'bg-[#c9830a] dark:bg-[#f0a842]',
  3: 'bg-[#4caf7d] dark:bg-[#5cc98a]',
  4: 'bg-[#4caf7d] dark:bg-[#5cc98a]',
}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs leading-normal text-[#6b5f58] dark:text-[#9b9a92]">
                    Longer passphrases are harder to crack and easier to remember.
                  </span>
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="mb-3.5">
                <label className={cn(labelClass, 'mb-1.5 block')} htmlFor="newPassword">
                  New Password
                </label>
                ...
                <div className="relative">
                  <input
                    ...
                    onBlur={handleBlur}
                    className={cn(
                      inputBaseClass(errors.newPassword, touched.newPassword && !errors.newPassword),
                      'pr-10'
                    )}
              ...
              {/* Confirm Password */}
              <div className="mb-4">
                <label className={cn(labelClass, 'mb-1.5 block')} htmlFor="confirmPassword">
                  Confirm Password
                </label>
                ...
                <div className="relative">
                  <input
                    ...
                    aria-describedby={errors.confirmPassword ? 'e-confirmpw' : undefined}
                  />
                  <button
                    type="button"
