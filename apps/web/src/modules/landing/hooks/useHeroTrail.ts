...
const toneClasses: Record<TrailCard['tone'], string> = {
  ...
  green: 'border-[rgba(45,106,71,0.35)] bg-[rgba(45,106,71,0.14)] text-[#2d6a47] dark:border-[rgba(92,201,138,0.42)] dark:bg-[rgba(92,201,138,0.16)] dark:text-[#5cc98a]',
  amber: 'border-[rgba(138,98,0,0.35)] bg-[rgba(138,98,0,0.14)] text-[#8a6200] dark:border-[rgba(240,168,66,0.42)] dark:bg-[rgba(240,168,66,0.16)] dark:text-[#f0a842]',
}
