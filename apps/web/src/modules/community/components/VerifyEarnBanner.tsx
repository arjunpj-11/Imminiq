    ...
    <div className="flex flex-wrap items-center justify-between gap-5 rounded-[20px] border-[1.5px] border-[rgba(196,154,44,0.2)] bg-[rgba(196,154,44,0.06)] p-6 dark:border-[rgba(196,154,44,0.18)] dark:bg-[rgba(196,154,44,0.05)]">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="max-w-[25rem] text-[12.5px] leading-[1.55] text-[#6b5f58] dark:text-[#9b9a92]">
            Vote on community submissions, help keep knowledge accurate, and earn coins every time you're in the majority.
          </p>

          <div className="mt-3 flex flex-wrap items-center gap-5">
            <div>
              <span className="font-['Playfair_Display',serif] text-[20px] font-black text-[#1a1714] dark:text-[#f2f0eb]">
                {banner.queueCount}
              </span>
              <span className="ml-1.5 font-['DM_Mono',monospace] text-[9px] uppercase tracking-widest text-[#9b9a92]">
                in queue
              </span>
            </div>
            <div className="h-5 w-px bg-[#e0d0c5] dark:bg-white/10" />
            <div>
              <span className="font-['Playfair_Display',serif] text-[20px] font-black text-[#c49a2c]">
                +{banner.rewardCoins}
              </span>
              <span className="ml-1.5 font-['DM_Mono',monospace] text-[9px] uppercase tracking-widest text-[#9b9a92]">
                coins / review
