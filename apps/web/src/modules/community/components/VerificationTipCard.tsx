export default function VerificationTipCard() {
  return (
    <div className="rounded-[18px] border-[1.5px] border-[rgba(196,154,44,0.18)] bg-[rgba(196,154,44,0.04)] p-5 dark:border-[rgba(196,154,44,0.15)] dark:bg-[rgba(196,154,44,0.04)] max-[860px]:col-span-2 max-[560px]:col-span-1">
      <div className="mb-3 flex items-center gap-1.5 font-['DM_Mono',monospace] text-[8.5px] uppercase tracking-[0.12em] text-[#9b9a92]">
      ...
      <p className="mb-2.5 font-['Playfair_Display',serif] text-[13px] italic leading-[1.65] text-[#1a1714] dark:text-[#e0d5cb]">
