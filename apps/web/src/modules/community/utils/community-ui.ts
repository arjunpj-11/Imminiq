...
export const communitySurfaceClass =
  'rounded-[18px] border-[1.5px] border-[#e0d0c5] bg-[#fdf8f5] dark:border-white/9 dark:bg-[#1e1c19]'

export const communityMutedTextClass =
  'text-[#6b5f58] dark:text-[#9b9a92]'

export const communityEyebrowClass =
  "font-['DM_Mono',monospace] text-[8.5px] uppercase tracking-[0.12em]"

export const communityButtonClass =
  'inline-flex items-center justify-center gap-2 rounded-[10px] border-[1.5px] px-5 py-2.5 text-[13px] font-bold transition hover:-translate-y-px'
