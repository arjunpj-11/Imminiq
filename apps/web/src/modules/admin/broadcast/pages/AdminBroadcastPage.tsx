          ...
          <form onSubmit={submit} className="flex flex-col gap-4 p-6">
            <div className="rounded-xl border border-[#e8816a]/25 bg-linear-to-br from-[#e8816a]/12 to-transparent p-4">
              <div className="flex items-center gap-2 text-sm font-semibold">
                <UsersRound size={16} className="text-[#e8816a]" /> Audience
                studio
              </div>
              <p className="mt-1 text-xs leading-5 text-[#aaa59d]">
                Choose a community segment or hand-pick recipients for a focused
                message.
              </p>
            </div>
            ...
            <label className="admin-field">
              ...
              />
              <small>
                Internal path opened when a user selects the notification.
              </small>
            </label>
            {create.isError && (
          ...
          return (
            <div key={option}>
              ...
              <div className="h-1.5 overflow-hidden rounded-full bg-white/10">
                <div
                  className="h-full rounded-full bg-[#e8816a]"
                  style={{ width: `${share}%` }}
                />
              </div>
            </div>
