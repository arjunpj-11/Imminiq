  ...
  const exportPdf = async () => {
    ...
    try {
      ...
      await downloadTablePdf({
        ...
        description:
          "Learning trackers matching the selected administrator filters.",
        filters: [
      ...
      toast.success(
        "Tracker PDF downloaded",
        `${trackers.length} matching trackers exported.`,
      );
    } catch (error) {
            ...
            <div className="admin-table-scroll overflow-x-auto">
              <table className="admin-table w-full min-w-225 text-left text-sm">
                <caption className="sr-only">
                  Trackers matching the current filters
                </caption>
                <thead>
                  <tr>
                    <th scope="col">
