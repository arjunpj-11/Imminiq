...
export default function ProfileToast({ message, visible, tone }: IProfileToastProps) {
  return (
    <div
      ...
      aria-live="polite"
      className={cn(
        'pointer-events-none fixed bottom-[calc(72px+env(safe-area-inset-bottom,0))] right-4 z-200 flex max-w-[min(360px,calc(100vw-32px))] items-center gap-2.5 rounded-md border px-4 py-3 text-[13px] font-semibold shadow-[0_18px_56px_rgba(0,0,0,0.32)] backdrop-blur-xl transition-all duration-250 lg:bottom-7 lg:right-7',
        tone === 'error'
          ...
          : tone === 'success'
            ...
            : 'border-[rgba(184,76,43,0.22)] bg-[#1a1714]/95 text-[#f5ede4] dark:border-[rgba(232,129,106,0.28)] dark:bg-[#f2f0eb]/95 dark:text-(--text-primary)',
