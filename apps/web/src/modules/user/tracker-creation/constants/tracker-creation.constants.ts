...
export const TRACKER_CREATION_API_PATHS = {
  trackerIntake: '/trackers/create/tracker-intake',
  reuseSuggestions: (query: string) => `/community?${query}`,
  stepOne: '/trackers/create/step-1',
  stepTwo: '/trackers/create/step-2',
  generateRoadmap: '/trackers/create/generate-roadmap',
  activeRoadmapJob: '/trackers/create/roadmap-jobs/active',
  jobStatus: (jobId: string) => `/trackers/create/jobs/${jobId}/status`,
  jobResult: (jobId: string) => `/trackers/create/jobs/${jobId}/result`,
  evaluateJob: (jobId: string) => `/trackers/create/jobs/${jobId}/evaluate`,
  evaluationResult: (jobId: string) => `/trackers/create/jobs/${jobId}/evaluation-result`,
  analyzeClonedTracker: (trackerId: string) =>
    `/trackers/create/clones/${trackerId}/analyze-new-topics`,
} as const;
