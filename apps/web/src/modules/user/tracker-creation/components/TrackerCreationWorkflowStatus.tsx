...
export function TrackerCreationProgressStatusCard({
  logMessage,
  engineLabel,
  nextLabel,
  progress,
...
interface ITrackerCreationActivityChipsProps {
  chips: ActivityChip[];
...
export function TrackerCreationActivityChips({
  chips,
  activeActivityIndex,
  completed,
  ariaLabel,
}: ITrackerCreationActivityChipsProps) {
  return (
    <section
...
export function TrackerCreationWorkflowFooter() {
  return (
