...
import type { Section } from '../types/tracker-creation.types';
import { cn } from '../utils/cn';
import SkeletonBlock from '../../../../components/feedback/SkeletonBlock';
import { capitalize } from '../utils/tracker-creation-formatters';
...
export default function TrackerRoadmapReviewPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen flex-col bg-(--surface-canvas) font-[DM_Sans,sans-serif] text-(--text-primary)">
        <TrackerCreationWorkflowHeader label="Roadmap Preview" />
