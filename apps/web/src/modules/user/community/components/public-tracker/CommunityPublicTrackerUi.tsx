...
export const HeartIcon = ({ filled = false }: { filled?: boolean }) => (
  ...
  >
    <path
      d="M20.8 4.6C18.9 2.8 15.9 2.9 14.1 4.8L12 7L9.9 4.8C8.1 2.9 5.1 2.8 3.2 4.6C1.2 6.6 1.3 9.8 3.4 11.8L12 20L20.6 11.8C22.7 9.8 22.8 6.6 20.8 4.6Z"
      stroke="currentColor"
      strokeWidth="1.65"
      strokeLinejoin="round"
    />
  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-[#e8ddd6] dark:bg-white/10">
        <div
          className="h-full rounded-full bg-(--brand-500) transition-all duration-500 dark:bg-(--brand-500)"
        ...
        <div className="mb-1.5 flex flex-wrap items-start justify-between gap-2">
          <div>
            <p className="text-[13px] font-bold text-(--text-primary) dark:text-(--text-primary)">
              ...
              {review.isMine && (
                <span className="ml-2 rounded-full bg-[rgba(184,76,43,0.08)] px-2 py-0.5 font-mono text-[8px] uppercase tracking-widest text-(--brand-500) dark:bg-[rgba(232,129,106,0.10)] dark:text-(--brand-500)">
                  You
                </span>
              )}
            </p>
