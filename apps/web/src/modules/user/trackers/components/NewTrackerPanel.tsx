...
const labelClass =
  "mb-1.5 block text-[11px] font-extrabold text-(--text-primary)";
const helperClass =
  "mt-1.5 block text-[10.5px] leading-[1.45] text-(--text-secondary)";
...
export default function NewTrackerPanel({
  open,
  onClose,
}: INewTrackerPanelProps) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setError(
        getUserFacingError(
          createError,
          "Could not create the tracker. Please try again.",
        ),
      );
    }
  };
  ...
  return (
    <>
      ...
      >
        <header className="relative overflow-hidden border-b border-(--border-subtle) px-6 py-5">
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="min-w-0">
              ...
              >
                Give the roadmap a clear outcome. You can refine its lessons and
        ...
        <div
          className={cn("flex-1 overflow-y-auto px-6 py-5", themedScrollbar)}
        >
          <div className="space-y-5">
            ...
            <label className="block">
              ...
              />
              <span className={helperClass}>
                A measurable goal helps the roadmap stay focused.
              </span>
            </label>
            ...
            <div className="grid grid-cols-2 gap-4 max-[460px]:grid-cols-1">
              <label className="block">
                ...
                <select
                  ...
                  disabled={createTrackerMutation.isPending}
                  onChange={(event) =>
                    setDomain(event.target.value as TrackerDomain)
                  }
                >
              ...
              <label className="block">
                ...
                <select
                  ...
                  disabled={createTrackerMutation.isPending}
                  onChange={(event) =>
                    setLevel(event.target.value as TrackerLevel)
                  }
                >
