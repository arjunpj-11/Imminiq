export const onboardingKeys = {
  ...
  roadmapJobStatus: (jobId: string) => [...onboardingKeys.all, 'roadmap-job-status', jobId] as const,
  roadmapJobResult: (jobId: string) => [...onboardingKeys.all, 'roadmap-job-result', jobId] as const,
