...
function PublishModal({
  ...
  return (
    <div
      ref={overlayRef}
      onClick={(e) => {
        if (e.target === overlayRef.current && !isPublishing) onClose()
      }}
      ...
      >
        ...
        <div className="px-6 pb-6 pt-4 sm:p-7">
          <div className="mb-6 flex items-start justify-between gap-3">
            <div>
              ...
              <h2
                ...
                className="font-['Playfair_Display',serif] text-[22px] font-extrabold leading-[1.15] tracking-[-0.4px] text-[#1a1714] dark:text-[#f2f0eb]"
              >
                Share your tracker
              </h2>
            ...
            <button
              ...
              className="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-[10px] text-[#6b5f58] transition hover:bg-[rgba(184,76,43,0.08)] hover:text-[#b84c2b] disabled:cursor-not-allowed disabled:opacity-50 dark:text-[#9b9a92] dark:hover:bg-[rgba(232,129,106,0.10)] dark:hover:text-[#e8816a]"
            >
              <CloseIcon />
            </button>
          </div>
          ...
          <div className="mb-1 flex items-center gap-2">
            <span className="font-['DM_Mono',monospace] text-[8.5px] uppercase tracking-[0.16em] text-[#b84c2b] dark:text-[#e8816a]">
              01
            </span>
            <span className="font-['DM_Mono',monospace] text-[8.5px] uppercase tracking-[0.16em] text-[#6b5f58] dark:text-[#9b9a92]">
              Basic info
            </span>
          ...
          <div className="mb-4 mt-3 space-y-4">
            <div>
              <label htmlFor="publish-name" className={fieldLabel}>
                Tracker name <span className="text-[#b84c2b]">*</span>
              </label>
              <input
                id="publish-name"
                type="text"
          ...
          <div className="mb-4 mt-3 space-y-4">
            <div>
              <label htmlFor="publish-domain" className={fieldLabel}>
                Domain <span className="text-[#b84c2b]">*</span>
              </label>
              <div className="relative">
                ...
                <svg
                  className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[#6b5f58] dark:text-[#9b9a92]"
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
                  fill="none"
          ...
          <div className="mt-3 mb-4 rounded-[14px] border-[1.5px] border-[#e0d0c5] bg-white/60 p-4 dark:border-white/9 dark:bg-white/[0.03]">
            <div className="flex items-center justify-between gap-4">
              <div className="min-w-0">
                <p className="text-[13px] font-semibold leading-tight text-[#1a1714] dark:text-[#f2f0eb]">
          ...
          <div className="flex items-center justify-between gap-3 border-t border-[#e0d0c5] pt-5 dark:border-white/9">
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                disabled={isPublishing}
                onClick={onClose}
                className="rounded-[10px] border-[1.5px] border-[#e0d0c5] px-4 py-2.5 text-[12.5px] font-semibold text-[#6b5f58] transition hover:bg-[rgba(26,23,20,0.05)] disabled:cursor-not-allowed disabled:opacity-50 dark:border-white/9 dark:text-[#9b9a92] dark:hover:bg-white/5"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-[10px] bg-[#b84c2b] px-5 py-2.5 text-[12.5px] font-bold text-white transition hover:bg-[#9a3e23] hover:shadow-[0_6px_20px_rgba(184,76,43,0.30)] disabled:cursor-not-allowed disabled:opacity-40 dark:bg-[#e8816a] dark:text-[#141412] dark:hover:bg-[#d4705a]"
              >
                {isPublishing ? (
                  <>
                    <SpinnerIcon />
    ...
    try {
      ...
      const message =
        error instanceof Error
          ? error.message
          : 'Failed to publish tracker. Please try again.'
                ...
                {onArchive && (
                  <>
                    ...
                    <button
                      type="button"
                      onClick={(event) =>
                        handleMenuAction(event, () => onArchive(tracker._id))
                      }
                      className={cn(
