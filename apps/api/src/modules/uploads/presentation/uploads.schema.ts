...
const optionalAltTextSchema = z.preprocess((value) => {
...
export type GenerateAIAvatarPreviewInput = z.infer<typeof generateAIAvatarPreviewSchema>;

export type GenerateAIBannerPreviewInput = z.infer<typeof generateAIBannerPreviewSchema>;
