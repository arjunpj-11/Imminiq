...
export class MongoUploadsRepository implements IUploadsRepository {
  ...
  constructor(
    ...
    this._recordRepository =
      dependencies.recordRepository ?? new MongoUploadsRecordRepository(mapper);

    this._profileRepository = dependencies.profileRepository ?? new MongoUploadsProfileRepository();
  }
