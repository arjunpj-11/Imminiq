...
import { GetAllSettingsUseCase } from '../use-cases/get-all-settings.usecase'
import { GetAppearanceSettingsUseCase } from '../use-cases/get-appearance-settings.usecase'
import { GetNotificationSettingsUseCase } from '../use-cases/get-notification-settings.usecase'
import { GetPrivacySettingsUseCase } from '../use-cases/get-privacy-settings.usecase'
import { GetGestureSettingsUseCase } from '../use-cases/get-gesture-settings.usecase'
import { UpdateAccountSettingsUseCase } from '../use-cases/update-account-settings.usecase'
import { UpdateAppearanceUseCase } from '../use-cases/update-appearance.usecase'
import { UpdateNotificationsUseCase } from '../use-cases/update-notifications.usecase'
import { UpdateQuietHoursUseCase } from '../use-cases/update-quiet-hours.usecase'
import { UpdateEmailDigestUseCase } from '../use-cases/update-email-digest.usecase'
import { UpdatePrivacyUseCase } from '../use-cases/update-privacy.usecase'
import { UpdateCodeEditorUseCase } from '../use-cases/update-code-editor.usecase'
import { UpdateCompilerUseCase } from '../use-cases/update-compiler.usecase'
import { UpdateAIBehaviourUseCase } from '../use-cases/update-ai-behaviour.usecase'
import { UpdateLearningJourneyUseCase } from '../use-cases/update-learning-journey.usecase'
import { UpdateGesturesUseCase } from '../use-cases/update-gestures.usecase'
import { UpdateCookieConsentUseCase } from '../use-cases/update-cookie-consent.usecase'
import { AcceptTermsUseCase } from '../use-cases/accept-terms.usecase'
import { ResetSettingsToDefaultsUseCase } from '../use-cases/reset-settings-to-defaults.usecase'
