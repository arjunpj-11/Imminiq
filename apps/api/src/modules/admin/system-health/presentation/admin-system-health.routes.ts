...
import { requireAdmin, type PrivilegedAdminMiddleware } from '../../../../shared/middlewares/admin.middleware';
...
export const createAdminSystemHealthRoutes = (
  ...
  router.patch(ADMIN_SYSTEM_HEALTH_ROUTE_PATHS.JOB_ACTION, requirePrivilegedMfa, controller.actOnJob);
  return router;
};
