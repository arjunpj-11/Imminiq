...
import type { IBulkUpdateAdminMockTestLifecycleUseCase } from './use-cases/bulk-update-admin-mock-test-lifecycle.usecase';
...
export type AdminMockTestsUseCases = {
  ...
  bulkUpdateLifecycle: IBulkUpdateAdminMockTestLifecycleUseCase;
