...
export type AdminUserActivityEntity = { id: string; action: string; module: string; severity: string; createdAt: Date }
export type AdminSecurityEventEntity = { id: string; eventType: string; outcome: string; createdAt: Date; ipAddress: string }
