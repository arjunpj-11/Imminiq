...
import type { AdminActionMeta, AdminManagedUserStatus, AdminUserFilter } from '../admin-users.types'

export type ListAdminUsersInput = { search: string; status: AdminUserFilter; page: number; limit: number }
