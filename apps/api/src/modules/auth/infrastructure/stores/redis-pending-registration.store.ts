...
export class RedisPendingRegistrationStore implements IPendingRegistrationStore {
  async save(
    ...
    await pendingRegistrationCache.save(identifier, JSON.stringify(registration), ttlSeconds);
  }
...
export const redisPendingRegistrationStore = new RedisPendingRegistrationStore();
