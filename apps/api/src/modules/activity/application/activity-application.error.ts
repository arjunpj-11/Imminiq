...
export class ActivityApplicationError extends ActivityDomainError {
  ...
  private constructor(
    statusCode: number,
    code: ActivityApplicationErrorCode,
    message: string,
  ) {
    super(code, message)
  ...
  static userNotFound(
    ...
    return new ActivityApplicationError(
      404,
      'ACTIVITY_USER_NOT_FOUND',
      message,
    )
  ...
  static invalidYear(
    message = 'Activity year is invalid',
  ): ActivityApplicationError {
    return new ActivityApplicationError(
      400,
      'INVALID_ACTIVITY_YEAR',
  ...
  static invalidUtcOffset(
    message = 'UTC offset is invalid',
  ): ActivityApplicationError {
    return new ActivityApplicationError(
      400,
      'INVALID_ACTIVITY_UTC_OFFSET',
...
export const isActivityApplicationError = (
  error: unknown,
): error is ActivityApplicationError =>
