...
export class GeminiGroqMockTestAIService implements MockTestAIServiceContract {
  private parseAIJson<T>(value: string): T {
...
- For non-coding questions, do not include the coding field.`
    ...
    try {
      ...
      return this.parseAIJson<GenerateQuestionsOutput>(response)
    } catch {
...
Return {
  ...
  "feedback": "brief feedback"
    ...
    try {
      ...
      return this.parseAIJson<EvaluateAnswerOutput>(response)
    } catch {
      throw new MockTestsDomainError(
