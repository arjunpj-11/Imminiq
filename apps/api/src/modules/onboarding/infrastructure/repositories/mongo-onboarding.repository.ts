  ...
  implements OnboardingRepositoryContract
{
  ...
  constructor(
    ...
    this._responseRepository =
      dependencies.responseRepository ??
      new MongoOnboardingResponseRepository(mapper)

    this._aiJobRepository =
      dependencies.aiJobRepository ??
      new MongoOnboardingAIJobRepository(mapper)

    this._roadmapRepository =
      dependencies.roadmapRepository ??
      new MongoOnboardingRoadmapRepository(mapper)
  }
