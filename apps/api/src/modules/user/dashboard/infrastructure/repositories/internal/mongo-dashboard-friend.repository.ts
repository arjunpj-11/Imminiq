    ...
    return this.execute(
      ...
      async () => {
        ...
        const friendships = (await Friend.find({
          ...
          .limit(MongoDashboardQueryUtils.safeLimit(limit, DASHBOARD_DEFAULT_FRIENDS_LIMIT))
        ...
        return friends.map((friend) => this._mapper.toDashboardFriendEntity(friend, profileMap));
      },
...
export const mongoDashboardFriendRepository = new MongoDashboardFriendRepository();
