...
export const CommunityTrackerProgressModel = TrackerProgress as unknown as LooseMongoModel;
export const CommunityTrackerTopicModel = TrackerTopic as unknown as LooseMongoModel;
export const CommunityTrackerSubtopicModel = TrackerSubtopic as unknown as LooseMongoModel;
...
export const CommunityReviewVoteModel = CommunityReviewVote as unknown as LooseMongoModel;
export const CommunityTrackerReviewModel = CommunityTrackerReview as unknown as LooseMongoModel;
