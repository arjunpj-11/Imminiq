...
export const createCommunityRoutes = (
  ...
  router.get(
    ...
    validateQuery(communityTrackerQuerySchema),
  ...
  router.post(COMMUNITY_ROUTE_PATHS.REVIEW_HELPFUL, communityController.toggleReviewHelpful);
  ...
  router.post(COMMUNITY_ROUTE_PATHS.TRACKER_LIKE, communityController.toggleTrackerLike);
