...
export interface ICommunityVerificationRepository {
  ...
  findVerificationQueue(query: FindVerificationQueueQuery): Promise<VerificationQueueResult>;
  ...
  createVerificationVote(data: CreateCommunityReviewVoteInput): Promise<CommunityReviewVoteEntity>;
  ...
  markVerificationVoteRewarded(voteId: string, rewardCoins: number): Promise<boolean>;
