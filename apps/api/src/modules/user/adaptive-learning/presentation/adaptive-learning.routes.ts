...
export const createAdaptiveLearningRoutes = (useCases: AdaptiveLearningUseCases) => {
  const router = Router();
  ...
  router.delete(ADAPTIVE_LEARNING_ROUTE_PATHS.ADVISOR_MESSAGES, controller.clearChat);
