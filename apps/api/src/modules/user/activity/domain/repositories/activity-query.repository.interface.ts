...
import type { ActivityAnalyticsRecord, ActivityTimeRange } from '../activity.types';
...
export interface IActivityQueryRepository {
  findActivityFeed(input: FindActivityFeedInput): Promise<FindActivityFeedResult>;

  findActivityAnalytics(input: FindActivityAnalyticsInput): Promise<ActivityAnalyticsRecord>;

  findDailyGoalState(input: FindDailyGoalStateInput): Promise<{
