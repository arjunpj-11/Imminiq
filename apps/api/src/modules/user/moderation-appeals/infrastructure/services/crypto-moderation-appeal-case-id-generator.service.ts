...
export class CryptoModerationAppealCaseIdGenerator implements IModerationAppealCaseIdGenerator {
  generate(): string {
...
export const cryptoModerationAppealCaseIdGenerator = new CryptoModerationAppealCaseIdGenerator();
