...
export interface IMockTestSharingRepository {
  ...
  findImportedSharedTest(input: FindImportedSharedTestInput): Promise<MockTestEntity | null>;

  enableTestSharing(input: EnableMockTestSharingInput): Promise<MockTestEntity | null>;
