...
export class MongoLeaderboardRepository implements ILeaderboardRepository {
  constructor(
    private readonly _queryRepository = new MongoLeaderboardQueryRepository(),
    private readonly _activityRepository = new MongoLeaderboardActivityRepository()
  ) {}
...
export const mongoLeaderboardRepository = new MongoLeaderboardRepository();
