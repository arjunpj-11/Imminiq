...
export interface ITrackerCommandRepository {
  ...
  softDeleteOwnedTracker(data: SoftDeleteOwnedTrackerInput): Promise<TrackerRecord | null>;

  archiveOwnedTracker(data: ArchiveOwnedTrackerInput): Promise<TrackerRecord | null>;

  restoreOwnedTracker(data: RestoreOwnedTrackerInput): Promise<TrackerRecord | null>;

  publishOwnedTracker(data: PublishTrackerInput): Promise<TrackerRecord | null>;

  unpublishOwnedTracker(data: UnpublishOwnedTrackerInput): Promise<TrackerRecord | null>;
}
