...
type GatewayReturn<T extends keyof ITrackerAIGateway> = Awaited<ReturnType<ITrackerAIGateway[T]>>;
...
export class AITrackerGateway implements ITrackerAIGateway {
  ...
  generateLessonPracticeQuestions(
    ...
    return this.runGateway<GatewayReturn<'generateLessonPracticeQuestions'>>(
      () =>
        generateLessonPracticeQuestions(input) as ReturnType<
          ITrackerAIGateway['generateLessonPracticeQuestions']
        >,
  ...
  generateLessonQuestionSolution(
    ...
    return this.runGateway<GatewayReturn<'generateLessonQuestionSolution'>>(
      () =>
        generateLessonQuestionSolution(input) as ReturnType<
          ITrackerAIGateway['generateLessonQuestionSolution']
        >,
  ...
  chatWithLessonQuestionSolutionDoubt(
    ...
    return this.runGateway<GatewayReturn<'chatWithLessonQuestionSolutionDoubt'>>(
      () =>
        chatWithLessonQuestionSolutionDoubt(input) as ReturnType<
          ITrackerAIGateway['chatWithLessonQuestionSolutionDoubt']
        >,
  ...
  generateLessonVisualization(
    ...
    return this.runGateway<GatewayReturn<'generateLessonVisualization'>>(
      () =>
        generateLessonVisualization(input) as ReturnType<
          ITrackerAIGateway['generateLessonVisualization']
        >,
  ...
  generateOptimizedCodeSolution(
    ...
    return this.runGateway<GatewayReturn<'generateOptimizedCodeSolution'>>(
      () =>
        generateOptimizedCodeSolution(input) as ReturnType<
          ITrackerAIGateway['generateOptimizedCodeSolution']
        >,
  ...
  private async runGateway<T>(operation: () => Promise<T>, code: string): Promise<T> {
    try {
