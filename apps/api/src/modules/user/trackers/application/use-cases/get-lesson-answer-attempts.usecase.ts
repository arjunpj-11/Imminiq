...
import type { LessonAnswerAttemptsDTO, TrackerLessonAccessPayloadDTO } from '../tracker.dto';
import type { ITrackerMapper } from '../tracker.mapper';
import type { ITrackerRepository } from '../../domain/repositories/tracker.repository.interface';

export interface IGetLessonAnswerAttemptsUseCase {
  execute(input: TrackerLessonAccessPayloadDTO): Promise<LessonAnswerAttemptsDTO>;
}
