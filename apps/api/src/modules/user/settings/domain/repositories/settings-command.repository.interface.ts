...
export type UpdateSettingsNotificationsInput = { userId: string; data: SettingsNotificationsUpdateInput };
export type UpdateSettingsNotificationTypesInput = { userId: string; types: Partial<NotificationTypeSettings> };
...
export interface ISettingsCommandRepository {
  ...
  updateNotificationTypes(input: UpdateSettingsNotificationTypesInput): Promise<UserSettingsEntity | null>;
