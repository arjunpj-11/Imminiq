...
export class MongoSettingsErrorMapper {
  static mapDuplicateSettingsRecordError(error: unknown): SettingsDomainError | null {
    ...
    return new SettingsDomainError('DUPLICATE_SETTINGS_RECORD', 'Duplicate settings record');
  }
