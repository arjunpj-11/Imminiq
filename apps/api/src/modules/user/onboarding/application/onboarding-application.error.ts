...
export class OnboardingApplicationError extends OnboardingDomainError {
  ...
  private constructor(statusCode: number, code: OnboardingApplicationErrorCode, message: string) {
    super(code, message);
    this.name = 'OnboardingApplicationError';
    this.statusCode = statusCode;
  }

  static aiQueueError(message = 'Failed to enqueue AI job'): OnboardingApplicationError {
...
export const isOnboardingApplicationError = (error: unknown): error is OnboardingApplicationError =>
