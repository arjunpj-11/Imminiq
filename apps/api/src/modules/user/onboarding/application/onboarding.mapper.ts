...
export interface IOnboardingMapper {
  toResponseDto(response: OnboardingResponseEntity | null): OnboardingResponseRecordDTO | null;

  toStatusDto(response: OnboardingResponseEntity | null): OnboardingStatusResultDTO;
