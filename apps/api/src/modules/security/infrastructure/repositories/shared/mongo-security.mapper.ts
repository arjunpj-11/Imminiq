...
export class MongoSecurityMapper {
  ...
  toSecurityUserEntity(user: MongoSecurityUserRecord | null): SecurityUserEntity | null {
    if (!user) {
      return null;
    }
  ...
  toSecuritySessionEntity(session: MongoSecuritySessionRecord): SecuritySessionEntity {
  ...
  toTwoFactorEntity(twoFactor: MongoTwoFactorRecord | null): TwoFactorEntity | null {
    if (!twoFactor) {
      return null;
    }
