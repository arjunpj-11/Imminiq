...
export class OtplibTwoFactorGateway implements ITwoFactorGateway {
  ...
  async verifyToken(data: { encryptedSecret: string; token: string }): Promise<boolean> {
    try {
...
export const otplibTwoFactorGateway = new OtplibTwoFactorGateway();
