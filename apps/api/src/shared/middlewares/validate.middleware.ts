...
export const validateUsernameParam: RequestParamHandler = (_req, _res, next, value) => {
...
const formatValidationErrors = (issues: readonly ValidationIssue[]): ValidationErrorMap => {
