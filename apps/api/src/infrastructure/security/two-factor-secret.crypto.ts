...
export class TwoFactorSecretCryptoError extends Error {
  ...
  constructor(code: TwoFactorSecretCryptoErrorCode, message: string) {
    super(message);
...
export const twoFactorSecretCrypto = new TwoFactorSecretCrypto();

export const encryptTotpSecret = (secret: string): string => twoFactorSecretCrypto.encrypt(secret);

export const decryptTotpSecret = (encryptedSecret: string): string =>
  twoFactorSecretCrypto.decrypt(encryptedSecret);
