...
export interface ICommunityReviewVote extends Document {
...
const communityReviewVoteSchema = new Schema<ICommunityReviewVote>(
  {
    submissionId: {
...
export const CommunityReviewVote =
  ...
  mongoose.model<ICommunityReviewVote>(
    'CommunityReviewVote',
