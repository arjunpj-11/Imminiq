...
const mockTestAnswerSchema = new Schema(
  {
    ...
    aiEvaluationId: { type: Schema.Types.ObjectId, ref: 'MockTestAIEvaluation', default: undefined },
...
export const MockTestAnswerModel = mongoose.models.MockTestAnswer || mongoose.model('MockTestAnswer', mockTestAnswerSchema)
