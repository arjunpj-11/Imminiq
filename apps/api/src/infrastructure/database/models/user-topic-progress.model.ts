...
export interface UserTopicProgressDocument extends Document {
...
const userTopicProgressSchema = new Schema<UserTopicProgressDocument>(
  {
    userId: {
...
export const UserTopicProgress = mongoose.model<UserTopicProgressDocument>(
  'UserTopicProgress',
