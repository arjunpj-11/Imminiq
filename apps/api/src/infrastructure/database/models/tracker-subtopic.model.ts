...
export interface TrackerSubtopicDocument extends Document {
...
const trackerSubtopicSchema = new Schema<TrackerSubtopicDocument>(
  {
    trackerId: {
...
export const TrackerSubtopic = mongoose.model<TrackerSubtopicDocument>(
  'TrackerSubtopic',
