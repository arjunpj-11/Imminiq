...
process.env.JWT_SECRET ??= 'test-jwt-secret-test-jwt-secret-test-jwt-secret-test-jwt-secret';
...
process.env.EMAIL_FROM ??= 'Imminiq Tests <tests@imminiq.local>';
...
process.env.CLOUDFLARE_AI_API_TOKEN ??= 'test-cloudflare-token';
